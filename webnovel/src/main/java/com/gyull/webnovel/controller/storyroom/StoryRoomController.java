...
import com.gyull.webnovel.domain.pagination.StoryPagingDTO;
...
public class StoryRoomController {
	...
	public String storyList(Model model, StoryCriteria scri, Authentication authentication, ServletResponse response, HttpSession session) throws IOException {
