package com.gyull.webnovel.controller.storyroom;
...
import com.gyull.webnovel.domain.pagination.StoryChapterPagingDTO;

import com.gyull.webnovel.security.domain.CustomUser;
import com.gyull.webnovel.service.storyroom.StoryRoomService;
import com.gyull.webnovel.service.storyroom.chapter.StoryChapterService;
...
public class StoryRoomChapterController {
	...
	public String chapterWrite(Model model, HttpSession session, ServletResponse response, Authentication authentication, StoryChapterCriteria sccri, Integer book_idx, BookChapterVO chapter, RedirectAttributes rttr) {
		...
		chapter.setChapter_content(chapter.getChapter_content().replaceAll("&nbsp;", " "));
		chapter.setChapter_content(chapter.getChapter_content().replaceAll("<br>", System.getProperty("line.separator")));
	...
	@RequestMapping(value="/storyRoom/chapter/example", method = RequestMethod.GET)
	public String example(Model model) {
		return "/storyRoom/chapter/example";
	}
}
