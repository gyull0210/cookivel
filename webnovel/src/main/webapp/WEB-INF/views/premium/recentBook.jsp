  ...
  <div class="container">
    <a class="navbar-brand fw-bold" href="#">작가연재</a>
      <ul class="navbar-nav me-auto">
        <li class="nav-item">
          <a class="nav-link text-dark" href="/premium/list">전체</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="/premium/recentBook">신작</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/premium/finishedBook">완결된 작품</a>
        </li>
      </ul>
    </div>
</nav>
	...
	<div class="list-group list-group-flush">
			...
			<div class="list-group-item">
				<ul class="nav nav-pills">
  					<li class="nav-item">
    					<a class="nav-link tab-link fs-6 ${pageMaker.cri.genre == null ? 'active':'' }" aria-current="page" href="/freeSeries/recentBook">전체</a>
  					</li>
					<li class="nav-item">
