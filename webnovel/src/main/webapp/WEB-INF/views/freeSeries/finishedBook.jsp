  ...
  <div class="container">
    <a class="navbar-brand fw-bold" href="#">자유연재</a>
      <ul class="navbar-nav me-auto">
        <li class="nav-item">
          <a class="nav-link" href="/freeSeries/recentBook">연재 작품</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="/freeSeries/finishedBook">완결된 작품</a>
        </li>
      </ul>
    </div>
</nav>
	...
	<div class="list-group list-group-flush">
			...
			<div class="list-group-item">
				<ul class="nav nav-pills">
  					<li class="nav-item">
    					<a class="nav-link tab-link fs-6 ${pageMaker.cri.genre == null ? 'active':'' }" aria-current="page" href="/freeSeries/finishedBook">전체</a>
  					</li>
					<li class="nav-item">
				...
				<div class="list-group-item d-flex justify-content-between align-items-start pt-2">
  				...
  				<div class="list-group-item pt-4">
  						<nav aria-label="Page navigation">
							...
							<form id="actionForm" action="/freeSeries/finishedBook" method="get">
...
actionForm.submit();
$("#book_idx").remove();
actionForm.prop("action","/freeSeries/finishedBook");
})
