  ...
  <div class="container">
    ...
    <div class="navbar-brand fw-bold">회차관리</div>
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item me-2">
          <a class="nav-link" href="/storyRoom/chapter/chapterNotice?book_idx=${book.book_idx}">공지사항</a>
        </li>
        <li class="nav-item">
	...
	<div class="list-group list-group-flush">
            ...
            <div class="list-group-item list-group-item-action d-flex justify-content-between">
                    	<div class="position-relative">
                    		<div>
                    			<c:out value="${(pageMaker.total - status.index) - ( (pageMaker.sccri.pageNum - 1) * 10)}화"/>
                    			<a class="stretched-link" href="/storyRoom/chapter/list?book_idx=${chapter.book_idx}&chapter_idx=${chapter.chapter_idx}">${chapter.chapter_title}</a>
                    		</div>
                    		<div>
                    	...
                    	<div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <li><a class="dropdown-item" href="/storyRoom/chapter/chapterModify?book_idx=${book.book_idx}&chapter_idx=${chapter.chapter_idx}">회차 수정</a></li>
                                <li><a class="dropdown-item" href="/storyRoom/chapter/chapterRemove?book_idx=${book.book_idx}&chapter_idx=${chapter.chapter_idx}">회차 삭제</a></li>
                            </ul>                   		
                    	</div>
            </div>
            </c:forEach>
  			 ...
  			 <div class="list-group-item pt-4">
  					<nav aria-label="Page navigation">
						...
						<form id="actionForm" action="/storyRoom/chapter/list" method="get">
